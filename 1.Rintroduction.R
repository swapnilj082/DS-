...
paste("Excler is",text) #Concatenate/ combine text using paste()function
...
#Data Structure Vector:Vector DataFrames
#Homogeneous vector
#vector
fruits =c("Banana","Apple","Orange","Strawbeery")
class(fruits)
...
n1=1.5:6.3#Default increament value is 1
...
x[3]=10
x[4]=7
x[c(1,3)]#1st & 3rd element will be display
...
#Relational operation with vector
...
food[food$taste=='Spicy' | food$price<300,] #0r
